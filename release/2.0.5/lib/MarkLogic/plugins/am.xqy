...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/am", xdmp:function(xs:QName("dbl10n:am")))
    return $map
};

declare function dbl10n:am()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/am.xqy"),
 plugin:register(dbl10n:capabilities(),"am.xqy"))
