...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/pl", xdmp:function(xs:QName("dbl10n:pl")))
    return $map
};

declare function dbl10n:pl()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/pl.xqy"),
 plugin:register(dbl10n:capabilities(),"pl.xqy"))
