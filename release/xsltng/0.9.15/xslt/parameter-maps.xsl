...
<xsl:stylesheet xmlns:vp="http://docbook.org/ns/docbook/variables/private"
   ...
   <xsl:variable name="vp:dynamic-parameters" as="map(xs:QName, item()*)">
      <xsl:map>
         ...
         <xsl:map-entry key="xs:QName('annotations')" select="$annotations"/>
         ...
         <xsl:map-entry key="xs:QName('xlink-css')" select="$xlink-css"/>
         <xsl:map-entry key="xs:QName('annotations-javascript-css')"
                        select="$annotations-javascript-css"/>
         <xsl:map-entry key="xs:QName('annotations-inline-css')"
                        select="$annotations-inline-css"/>
