...
{
  let $l10n := document {
<locale language="or" english-language-name="Oriya">

<info>
<authorgroup>
  <author><personname><firstname>Gora</firstname><surname>Mohanty</surname></personname>
  <email>gora_mohanty@yahoo.co.in</email>
...
<gentext key="appendix" text="ପରିଶିଷ୍ଠ"/>
<gentext key="Article" text="ନିବନ୍ଧ"/>
<gentext key="article" text="ନିବନ୍ଧ"/>
<gentext key="Author" text="ଲେଖକ"/>
<gentext key="Bibliography" text="ଗ୍ରନ୍ଥସୂଚୀ"/>
<gentext key="bibliography" text="ଗ୍ରନ୍ଥସୂଚୀ"/>
<gentext key="Book" text="ପୁସ୍ତକ"/>
<gentext key="book" text="ପୁସ୍ତକ"/>
<gentext key="CAUTION" text="ସାବଧାନ"/>
<gentext key="Caution" text="ସାବଧାନ"/>
<gentext key="caution" text="ସାବଧାନ"/>
<gentext key="Chapter" text="ଅଧ୍ଯାୟ"/>
<gentext key="chapter" text="ଅଧ୍ଯାୟ"/>
<gentext key="Colophon" text="ପୁସ୍ତକ ପରିଚୟ"/>
<gentext key="colophon" text="ପୁସ୍ତକ ପରିଚୟ"/>
<gentext key="Copyright" text="ସ୍ବତ୍ତ୍ବାଧୀକାର"/>
<gentext key="copyright" text="ସ୍ବତ୍ତ୍ବାଧୀକାର"/>
...
<gentext key="example" text="ଉଦାହରଣ"/>
<gentext key="Figure" text="ଚିତ୍ର"/>
<gentext key="figure" text="ଚିତ୍ର"/>
<gentext key="Glossary" text="ଶବ୍ଦକୋଷ"/>
<gentext key="glossary" text="ଶବ୍ଦକୋଷ"/>
<gentext key="GlossSee" text="ଦେଖନ୍ତୁ"/>
<gentext key="glosssee" text="ଦେଖନ୍ତୁ"/>
<gentext key="GlossSeeAlso" text="ଏହା ଭି ଦେଖନ୍ତୁ"/>
<gentext key="glossseealso" text="ଏହା ଭି ଦେଖନ୍ତୁ"/>
<gentext key="IMPORTANT" text="ଗୁରୁତ୍ବପୂର୍ଣ୍ଣ"/>
<gentext key="important" text="ଗୁରୁତ୍ବପୂର୍ଣ୍ଣ"/>
<gentext key="Important" text="ଗୁରୁତ୍ବପୂର୍ଣ୍ଣ"/>
<gentext key="Index" text="ଅନୁକ୍ରମଣିକା"/>
<gentext key="index" text="ଅନୁକ୍ରମଣିକା"/>
<gentext key="ISBN" text="ଆଇ.ଏସ.ବି.ଏନ."/>
<gentext key="isbn" text="ଆଇ.ଏସ.ବି.ଏନ."/>
<gentext key="LegalNotice" text="ବୈଧାନିକ ସୂଚନା"/>
<gentext key="legalnotice" text="ବୈଧାନିକ ସୂଚନା"/>
<gentext key="MsgAud" text="ଶ୍ରୋତୃବର୍ଗ"/>
<gentext key="msgaud" text="ଶ୍ରୋତୃବର୍ଗ"/>
<gentext key="MsgLevel" text="ସ୍ତର"/>
<gentext key="msglevel" text="ସ୍ତର"/>
<gentext key="MsgOrig" text="ଉତ୍ପତ୍ତି"/>
<gentext key="msgorig" text="ଉତ୍ପତ୍ତି"/>
<gentext key="NOTE" text="ଟୀକା"/>
<gentext key="Note" text="ଟୀକା"/>
<gentext key="note" text="ଟୀକା"/>
<gentext key="Part" text="ଭାଗ"/>
<gentext key="part" text="ଭାଗ"/>
<gentext key="Preface" text="ଭୂମିକା"/>
<gentext key="preface" text="ଭୂମିକା"/>
<gentext key="Procedure" text="କାର୍ଯ୍ଯବିଧି"/>
<gentext key="procedure" text="କାର୍ଯ୍ଯବିଧି"/>
<gentext key="ProductionSet" text="ଉତ୍ପାଦନ"/>
...
<gentext key="revhistory" text="ସଂଶୋଧନ ଇତିହାସ"/>
<gentext key="revision" text="ସଂଶୋଧନ"/>
<gentext key="Revision" text="ସଂଶୋଧନ"/>
<gentext key="sect1" text="ଅଂଶ"/>
<gentext key="sect2" text="ଅଂଶ"/>
<gentext key="sect3" text="ଅଂଶ"/>
<gentext key="sect4" text="ଅଂଶ"/>
...
<gentext key="Set" text="ବିନ୍ଯାସ କରନ୍ତୁ"/>
<gentext key="setindex" text="ଅନୁକ୍ରମଣିକା ବିନ୍ଯାସ କରନ୍ତୁ"/>
<gentext key="SetIndex" text="ଅନୁକ୍ରମଣିକା ବିନ୍ଯାସ କରନ୍ତୁ"/>
<gentext key="Sidebar" text="ପାର୍ଶ୍ବପଟି"/>
<gentext key="sidebar" text="ପାର୍ଶ୍ବପଟି"/>
...
<gentext key="TIP" text="ସଂକେତ"/>
<gentext key="Tip" text="ସଂକେତ"/>
<gentext key="Warning" text="ଚେତାବନୀ"/>
<gentext key="warning" text="ଚେତାବନୀ"/>
<gentext key="WARNING" text="ଚେତାବନୀ"/>
...
<gentext key="pgs" text="ପୃଷ୍ଠା"/>
<gentext key="Revisedby" text="ଦ୍ବାରା ସଂଶୋଧିତ: "/>
<gentext key="revisedby" text="ଦ୍ବାରା ସଂଶୋଧିତ: "/>
...
<gentext key="listofexamples" text="ଉଦାହରଣ ତାଲିକା"/>
<gentext key="ListofFigures" text="ଚିତ୍ର ତାଲିକା"/>
<gentext key="listoffigures" text="ଚିତ୍ର ତାଲିକା"/>
<gentext key="ListofProcedures" text="କାର୍ଯ୍ଯବିଧି ତାଲିକା"/>
<gentext key="listofprocedures" text="କାର୍ଯ୍ଯବିଧି ତାଲିକା"/>
<gentext key="listoftables" text="ସାରଣୀ ତାଲିକା"/>
<gentext key="ListofTables" text="ସାରଣୀ ତାଲିକା"/>
<gentext key="ListofUnknown" text="ଅଜଣାର ତାଲିକା"/>
<gentext key="listofunknown" text="ଅଜଣାର ତାଲିକା"/>

<gentext key="nav-home" text="ମୂଳ ସ୍ଥାନ"/>
<gentext key="nav-next" text="ପରବର୍ତ୍ତୀ"/>
<gentext key="nav-next-sibling" text="ଦ୍ରୁତ ଆଗକୁ"/>
<gentext key="nav-prev" text="ପୂର୍ବ"/>
<gentext key="nav-prev-sibling" text="ଦ୍ରୁତ ପଛକୁ"/>
<gentext key="nav-up" text="ଉପରକୁ"/>
<gentext key="nav-toc" text="ସୂଚୀପତ୍ର"/>

<gentext key="Draft" text="ଡ୍ରାଫ୍ଟ"/>
<gentext key="above" text="ଉପରେ"/>
<gentext key="below" text="ତଳେ"/>
<gentext key="sectioncalled" text="ଏହି ଅଂଶର ନାମ"/>
<gentext key="index symbols" text="ପ୍ରତୀକ"/>
<gentext key="writing-mode" text="lr-tb"/>

<gentext key="lowercase.alpha" text="ଅଆଇଈଉଊଋଏଐଓଔକଖଗଘଙଚଛଜଝଞଟଠଡଢଣତଥଦଧନପଫବଭମଯୟରଲଳୱଶଷସହ"/>
<gentext key="uppercase.alpha" text="ଅଆଇଈଉଊଋଏଐଓଔକଖଗଘଙଚଛଜଝଞଟଠଡଢଣତଥଦଧନପଫବଭମଯୟରଲଳୱଶଷସହ"/>
...
<template name="person-name">ପ୍ରଥମ-ଶେଷ</template>
...
<template name="warning">%t</template>
<template name="olink.document.citation">%oରେ</template>
<template name="olink.page.citation"> (ପୃଷ୍ଠା %p)</template>
<template name="page.citation"> [%p]</template>
<template name="page">(ପୃଷ୍ଠା %p)</template>
<template name="docname">%oରେ</template>
<template name="docnamelong">%o ନାମକ ଦଲିଲରେ</template>
<template name="pageabbrev">(ପୃ. %p)</template>
<template name="Page">ପୃଷ୍ଠା %p</template>
...
<template name="format">ମାସ/ଦିନ/ବର୍ଷ</template>
</context>

<context name="termdef">
<template name="prefix">[ବ୍ଯାଖ୍ଯା: </template>
<template name="suffix">]</template>
</context>

<context name="datetime-full">
<template name="January">ଜାନୁଆରି</template>
<template name="February">ଫେବ୍ରୁଆରି</template>
<template name="March">ମାର୍ଚ୍ଚ</template>
<template name="April">ଏପ୍ରିଲ</template>
<template name="May">ମେ</template>
<template name="June">ଜୁନ</template>
<template name="July">ଜୁଲାଇ</template>
<template name="August">ଅଗଷ୍ଟ</template>
<template name="September">ସେପ୍ଟେମ୍ବର</template>
<template name="October">ଅକ୍ଟୋବର</template>
<template name="November">ନଭେମ୍ବର</template>
<template name="December">ଡିସେମ୍ବର</template>
<template name="Monday">ସୋମବାର</template>
<template name="Tuesday">ମଙ୍ଗଳବାର</template>
<template name="Wednesday">ବୁଧବାର</template>
<template name="Thursday">ଗୁରୁବାର</template>
<template name="Friday">ଶୁକ୍ରବାର</template>
<template name="Saturday">ଶନିବାର</template>
<template name="Sunday">ରବିବାର</template>
</context>

<context name="datetime-abbrev">
<template name="Jan">ଜାନ</template>
<template name="Feb">ଫେବ</template>
<template name="Mar">ମାର</template>
<template name="Apr">ଏପ୍ର</template>
<template name="May">ମେ</template>
<template name="Jun">ଜୁନ</template>
<template name="Jul">ଜୁଲ</template>
<template name="Aug">ଅଗ</template>
<template name="Sep">ସେପ</template>
<template name="Oct">ଅକ୍ଟ</template>
<template name="Nov">ନଭ</template>
<template name="Dec">ଡିସ</template>
<template name="Mon">ସୋମ</template>
<template name="Tue">ମଂଗଳ</template>
<template name="Wed">ବୁଧ</template>
<template name="Thu">ଗୁରୁ</template>
<template name="Fri">ଶୁକ୍ର</template>
<template name="Sat">ଶନି</template>
<template name="Sun">ରବି</template>
</context>
