...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/id", xdmp:function(xs:QName("dbl10n:id")))
    return $map
};

declare function dbl10n:id()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/id.xqy"),
 plugin:register(dbl10n:capabilities(),"id.xqy"))
