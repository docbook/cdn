...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/eu", xdmp:function(xs:QName("dbl10n:eu")))
    return $map
};

declare function dbl10n:eu()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/eu.xqy"),
 plugin:register(dbl10n:capabilities(),"eu.xqy"))
