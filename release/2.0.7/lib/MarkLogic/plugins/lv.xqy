...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/lv", xdmp:function(xs:QName("dbl10n:lv")))
    return $map
};

declare function dbl10n:lv()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/lv.xqy"),
 plugin:register(dbl10n:capabilities(),"lv.xqy"))
