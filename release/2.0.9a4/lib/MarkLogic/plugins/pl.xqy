...
{
  let $l10n := document {
<locale language="pl" english-language-name="Polish">

<info>
<authorgroup>
  <author><personname><firstname>Rafa³</firstname><surname>Kleger-Rudomin</surname></personname>
  <email>klakier@pld.org.pl</email>
