...
<xsl:template match="d:setindex/d:indexinfo"/>
<xsl:template match="d:setindex/d:info"/>
<xsl:template match="d:setindex/d:title"/>
<xsl:template match="d:setindex/d:subtitle"/>
<xsl:template match="d:setindex/d:titleabbrev"/>
