...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/nn", xdmp:function(xs:QName("dbl10n:nn")))
    return $map
};

declare function dbl10n:nn()
as element(l:l10n)
{
  let $l10n := document {
...
<l:gentext key="Caution" text="Obs"/>
<l:gentext key="caution" text="OBS Obs"/>
...
<l:gentext key="important" text="viktig viktig"/>
<l:gentext key="Important" text="Viktig"/>
...
<l:gentext key="Note" text="Notat"/>
<l:gentext key="note" text="NOTAT Notat"/>
...
<l:gentext key="See" text="Sjå"/>
<l:gentext key="seealso" text="sjå òg sjå òg"/>
...
<l:gentext key="Task" text="Task" lang="en"/>
<l:gentext key="tip" text="tips tips"/>
<l:gentext key="TIP" text="TIPS"/>
<l:gentext key="Tip" text="Tips"/>
<l:gentext key="Warning" text="Åtvaring"/>
<l:gentext key="warning" text="åtvaring åtvaring"/>
<l:gentext key="WARNING" text="ÅTVARING"/>
...
( xdmp:log("Register docbook/nn.xqy"),
 plugin:register(dbl10n:capabilities(),"nn.xqy"))
