...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/nl", xdmp:function(xs:QName("dbl10n:nl")))
    return $map
};

declare function dbl10n:nl()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/nl.xqy"),
 plugin:register(dbl10n:capabilities(),"nl.xqy"))
