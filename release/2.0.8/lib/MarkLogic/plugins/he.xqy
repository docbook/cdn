...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/he", xdmp:function(xs:QName("dbl10n:he")))
    return $map
};

declare function dbl10n:he()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/he.xqy"),
 plugin:register(dbl10n:capabilities(),"he.xqy"))
