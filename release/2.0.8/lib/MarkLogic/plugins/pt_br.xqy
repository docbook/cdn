...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/pt_br", xdmp:function(xs:QName("dbl10n:pt_br")))
    return $map
};

declare function dbl10n:pt_br()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/pt_br.xqy"),
 plugin:register(dbl10n:capabilities(),"pt_br.xqy"))
