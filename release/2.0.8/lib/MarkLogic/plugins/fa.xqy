...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/fa", xdmp:function(xs:QName("dbl10n:fa")))
    return $map
};

declare function dbl10n:fa()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/fa.xqy"),
 plugin:register(dbl10n:capabilities(),"fa.xqy"))
