...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/el", xdmp:function(xs:QName("dbl10n:el")))
    return $map
};

declare function dbl10n:el()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/el.xqy"),
 plugin:register(dbl10n:capabilities(),"el.xqy"))
