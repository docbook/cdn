...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/xh", xdmp:function(xs:QName("dbl10n:xh")))
    return $map
};

declare function dbl10n:xh()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/xh.xqy"),
 plugin:register(dbl10n:capabilities(),"xh.xqy"))
