...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/or", xdmp:function(xs:QName("dbl10n:or")))
    return $map
};

declare function dbl10n:or()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/or.xqy"),
 plugin:register(dbl10n:capabilities(),"or.xqy"))
