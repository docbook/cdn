...
<xsl:template name="calsTable">
  <xsl:apply-templates select="tgroup|mediaobject|graphic" mode="calsTable"/>
  <xsl:apply-templates select="caption"/>
</xsl:template>

<xsl:template match="tgroup" mode="calsTable">
...
<xsl:template match="mediaobject|graphic" mode="calsTable">
  <xsl:apply-templates select="."/>
</xsl:template>
