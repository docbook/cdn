...
<xsl:template match="set">
  ...
  <xsl:variable name="preamble"
                select="*[not(self::book or self::set or self::setindex or article)]"/>

  <xsl:variable name="content" select="book|set|setindex|article"/>
...
<xsl:template match="set/info"></xsl:template>
<xsl:template match="set/title"></xsl:template>
<xsl:template match="set/subtitle"></xsl:template>
<xsl:template match="set/titleabbrev"></xsl:template>
<xsl:template match="setindex/setindexinfo"></xsl:template>
