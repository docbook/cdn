...
<xsl:template match="setindex/indexinfo"/>
<xsl:template match="setindex/info"/>
<xsl:template match="setindex/title"/>
<xsl:template match="setindex/subtitle"/>
<xsl:template match="setindex/titleabbrev"/>
