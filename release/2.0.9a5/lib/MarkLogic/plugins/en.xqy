...
{
  let $l10n := document {
<locale language="en" english-language-name="English">
...
<gentext key="abstract" text="Abstract"/>
<gentext key="Acknowledgements" text="Acknowledgements"/>
<gentext key="acknowledgements" text="Acknowledgements"/>
...
<gentext key="qandadiv" text="Q &amp; A"/>
<gentext key="QandASet" text="Frequently Asked Questions"/>
...
<gentext key="reference" text="Reference"/>
<gentext key="References" text="References"/>
...
<template name="annotation">%t</template>
...
<template name="format">[D01] [MNn,*-3] [Y0001]</template>
</context>
...
<template name="option">Option</template>
...
<template name="space">Spacebar</template>
<template name="tab">Tab</template> <!--  Alternative: &#x27fc; -->
