...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/gu", xdmp:function(xs:QName("dbl10n:gu")))
    return $map
};

declare function dbl10n:gu()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/gu.xqy"),
 plugin:register(dbl10n:capabilities(),"gu.xqy"))
