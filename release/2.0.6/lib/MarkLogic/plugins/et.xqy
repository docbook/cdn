...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/et", xdmp:function(xs:QName("dbl10n:et")))
    return $map
};

declare function dbl10n:et()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/et.xqy"),
 plugin:register(dbl10n:capabilities(),"et.xqy"))
