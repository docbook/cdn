...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/eo", xdmp:function(xs:QName("dbl10n:eo")))
    return $map
};

declare function dbl10n:eo()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/eo.xqy"),
 plugin:register(dbl10n:capabilities(),"eo.xqy"))
