...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/it", xdmp:function(xs:QName("dbl10n:it")))
    return $map
};

declare function dbl10n:it()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/it.xqy"),
 plugin:register(dbl10n:capabilities(),"it.xqy"))
