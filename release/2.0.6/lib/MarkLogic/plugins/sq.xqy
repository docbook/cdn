...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/sq", xdmp:function(xs:QName("dbl10n:sq")))
    return $map
};

declare function dbl10n:sq()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/sq.xqy"),
 plugin:register(dbl10n:capabilities(),"sq.xqy"))
