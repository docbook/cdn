...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/de", xdmp:function(xs:QName("dbl10n:de")))
    return $map
};

declare function dbl10n:de()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/de.xqy"),
 plugin:register(dbl10n:capabilities(),"de.xqy"))
