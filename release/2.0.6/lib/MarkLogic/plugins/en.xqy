...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/en", xdmp:function(xs:QName("dbl10n:en")))
    return $map
};

declare function dbl10n:en()
as element(l:l10n)
{
  let $l10n := document {
...
<l:template name="annotation" text="%t"/>
...
<l:context name="datetime"><l:template name="format" text="[D01] [MNn,*-3] [Y0001]"/>
</l:context>
<l:context name="date"><l:template name="format" text="[D01] [MNn,*-3] [Y0001]"/>
</l:context>
...
<l:template name="insert" text="Insert"/>
<l:template name="left" text="←"/>
<l:template name="meta" text="Meta"/>
<l:template name="option" text="Option"/>
<l:template name="pagedown" text="Page Down"/>
<l:template name="pageup" text="Page Up"/>
<l:template name="right" text="→"/>
<l:template name="shift" text="Shift"/>
<l:template name="space" text="Spacebar"/>
<l:template name="tab" text="Tab"/>
...
( xdmp:log("Register docbook/en.xqy"),
 plugin:register(dbl10n:capabilities(),"en.xqy"))
