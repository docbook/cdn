...
{
    let $map := map:map()
    let $_   := map:put($map, "http://docbook.org/localization/th", xdmp:function(xs:QName("dbl10n:th")))
    return $map
};

declare function dbl10n:th()
as element(l:l10n)
{
  let $l10n := document {
...
( xdmp:log("Register docbook/th.xqy"),
 plugin:register(dbl10n:capabilities(),"th.xqy"))
